...
ActiveRecord::Schema.define(version: 2021_05_26_091637) do
  ...
  create_table "sipping_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["purchase_management_id"], name: "index_sipping_addresses_on_purchase_management_id"
  end
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "famiry_name", default: "", null: false
    t.string "last_name", default: "", null: false
    t.string "famiry_name_kana", default: "", null: false
  ...
  add_foreign_key "sipping_addresses", "purchase_managements"
end
